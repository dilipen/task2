...
class CorporateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'mainbranch>', 'id', 'name', 'created_at', 'modified_at', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
...
class MainBranchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'branch>', 'id', 'name', 'created_at', 'modified_at', 'corporate', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
...
class SubDomainSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'user>', 'notification>', 'id', 'name', 'created_at', 'modified_at', 'branch', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'notificationuser>', 'id', 'message', 'created_at', 'modified_at', 'sub_domain', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
...
class CompanySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'subdomain>', 'user>', 'id', 'name', 'created_at', 'modified_at', 'main_branch', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
...
class UserNotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        # fields = ( 'id', 'notification', 'user', 'has_readed_at', 'readed_at', 'created_at', 'modified_at', )
        # extra_fields = ('{{my_custom_field_name}}', )
        # read_only_fields = ( 'created_at', 'modified_at', )
